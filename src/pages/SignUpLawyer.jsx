...
import { registerlawyerRoute } from '../utlis/APIRoutes';
...
const handleSubmit= async(event) =>{
  ...
  if (handlevalidation())
  {
    const {name,Cnic,Email,Lawyer_License_No,Password} = credentials; 
    const {data} =  await axios.post(registerlawyerRoute,{
        name,Cnic,Email,Lawyer_License_No,Password
    });
...
const handlevalidation = ()=>{
  const {name,Cnic,Email,Lawyer_License_No,Password,ConfirmPassword} = credentials;
  if(name.length < 3 )
  {
  ...
  if(Lawyer_License_No === "")
  {
    toast.error("Lawyer License is required",toastOptions);
  }
...
<Container>
      <div className="row-div">
        ...
        <div className='col2'>
          ...
          <h2 className='mt-1'>Welcome To E-Court</h2>
          <h4 className='mt-2 mb-4'>Lawyer PANEL</h4>
        ...
        <div className="row">
          ...
          <div className="col form__div">
            <input type="text" className="form-control form__input" name='Cnic' onChange={(e) => handleChange(e)} />
        ...
        <div className="row">
          ...
          <div className="col form__div">
            <input type="text" className="form-control form__input" name='Lawyer_License_No' onChange={(e) => handleChange(e)}  autoComplete="Cnic"  />
            <label htmlFor="Lawyer_License_No" className="form__label">Lawyer_License_No</label>

          </div>
        </div>
        <div className="row">
          <div className="col form__div">
            <input type="password" className="form-control form__input" id='prow2' name='Password' onChange={(e) => handleChange(e)} autoComplete="new-password" />
        ...
        <span className='d-flex justify-content-end px-5  mb-3 '>
            Already have an account ? <Link to="/lawyerlogin">Login.</Link>
          </span>
