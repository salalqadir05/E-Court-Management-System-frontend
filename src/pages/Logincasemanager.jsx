...
import { logincasemanagerRoute } from '../utlis/APIRoutes';
import LoginAlertFailed from './Alerts/LoginFailed';


function Logincasemanager() {
...
const handleChange = (e) => {
  ...
  event.preventDefault();
    ...
    {
      const { Email, Password } = credentials;
      const { data } = await axios.post(logincasemanagerRoute, {
        Email, Password
      });
      ...
      if (data.status === true) {
        localStorage.setItem(
          ...
          JSON.stringify(data.checkcasemanager)
        );
      ...
      <div className="row-div">
        ...
        <div className='col2'>
          ...
          <div className="l-form">
            ...
            Already have an account ? <Link to="/casemanagerregister">Register.</Link>
          </span>
